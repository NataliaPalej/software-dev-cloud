...
def subDialog(window):
    ...
    label1 = Label(window2, text="Subtract Dialog", fg="black", bg="orchid1", font=("arial", 16, "bold"))
    label1.place(x=60, y=30)  # place on screen

    label2 = Label(frame, text="Value1", fg="black", width=10, font=("arial", 10, "bold"))  #
    ...
    label3 = Label(frame, text="Value2", fg="black", width=10, font=("arial", 10, "bold"))  #
    ...
    button5 = Button(frame, text="Subtract", fg="black", font=("arial", 10, "bold"), command=subtract)
