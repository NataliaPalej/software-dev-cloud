...
button1 = Button(window, text="IncrementV1", fg="black", bg="pink", font=("arial", 12, "bold"), command=incrV1Event)
button1.place(x=10, y=140)

button2 = Button(window, text="IncrementV2", fg="black", bg="pink", font=("arial", 12, "bold"), command=incrV2Event)
button2.place(x=140, y=140)

button4 = Button(window, text="Add", fg="black", bg="pink", width=10, font=("arial", 10, "bold"), command=addEvent)
button4.place(x=25, y=177)

entry4 = Entry(window)
entry4.insert(END, '')
entry4.place(x=120, y=180)

button5 = Button(window, text="Multiply", fg="black", bg="pink", width=10, font=("arial", 10, "bold"), command=multiplyEvent)
button5.place(x=25, y=217)
