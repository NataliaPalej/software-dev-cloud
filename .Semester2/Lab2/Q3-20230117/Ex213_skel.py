...
# -------------------------------
button1 = Button(window, text="Win", fg="black", width=7, bg="pink", font=("arial", 10, "bold"), command=winEvent)
button1.place(x=40, y=180)

button2 = Button(window, text="Draw", fg="black", width=7, bg="pink", font=("arial", 10, "bold"), command=drawEvent)
button2.place(x=120, y=180)

button3 = Button(window, text="Loss", fg="black", width=7, bg="pink", font=("arial", 10, "bold"), command=lossEvent)
button3.place(x=40, y=220)

button4 = Button(window, text="Exit", fg="black", width=7, bg="pink", font=("arial", 10, "bold"), command=exitEvent)
button4.place(x=120, y=220)

button5 = Button(window, text="readWins", fg="black", width=10, bg="magenta", font=("arial", 10, "bold"), command=getWinsEvent)
