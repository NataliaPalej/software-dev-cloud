...
label1 = Label(window, text="Search Application", fg="black",bg="pink", font=("arial", 16, "bold"))   #
...
label3b = Label(window, text="Enter Search Item", fg="purple", width=18, font=("arial", 12, "bold"))   #
label3b.place(x=10, y=120)



button5= Button(window, text="Perform LinearSearch", fg="black", bg="pink", font=("arial", 12, "bold"), command=searchEvent)
