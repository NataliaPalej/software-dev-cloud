...
label1 = Label(window, text="Product example", fg="black", bg="hotpink1", font=("arial", 16, "bold"))
label1.place(x=60, y=30)  # place on screen

label2 = Label(frame, text="Make", fg="black", width=15, font=("arial", 10, "bold"))  #
...
label3 = Label(frame, text="Model", fg="black", width=15, font=("arial", 10, "bold"))  #
...
label4 = Label(frame, text="Price", fg="black", width=15, font=("arial", 10, "bold"))  #
...
label5 = Label(frame, text="Type", fg="black", width=15, font=("arial", 10, "bold"))  #
...
label6 = Label(frame, text="Description", fg="black", width=15, font=("arial", 10, "bold"))  #
...
button5 = Button(frame, text="Next", fg="black", bg="lightblue1", font=("arial", 10, "bold"), command=nextCmd)
button5.grid(row=10, column=0, sticky=W + E)

button6 = Button(frame, text="Prev", fg="black", bg="lightblue1", font=("arial", 10, "bold"), command=prevCmd)
button6.grid(row=10, column=1, sticky=W + E)

button7 = Button(frame, text="First", fg="black", bg="lightseagreen", font=("arial", 10, "bold"), command=firstCmd)
button7.grid(row=11, column=0, sticky=W + E)

button8 = Button(frame, text="Last", fg="black", bg="lightseagreen", font=("arial", 10, "bold"), command=lastCmd)
