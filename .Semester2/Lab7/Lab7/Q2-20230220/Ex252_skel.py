...
label1 = Label(window, text="Student Details", fg="black", bg="bisque", font=("arial", 16, "bold"))  #
label1.place(x=70, y=30)  # place on screen

label2 = Label(window, text="Student No", fg="black", width=8, font=("arial", 10, "bold"))  #
...
label3 = Label(window, text="Name", fg="black", width=12, font=("arial", 10, "bold"))  #
...
label4 = Label(window, text="Address", fg="black", width=8, font=("arial", 10, "bold"))  #
...
label5 = Label(window, text="Course", fg="black", width=12, font=("arial", 10, "bold"))  #
...
label6 = Label(window, text="Qualification", fg="black", width=12, font=("arial", 10, "bold"))  #
...
label7 = Label(window, text="Level", fg="black", width=12, font=("arial", 10, "bold"))  #
...
# -------------------------------
button3 = Button(window, text="updateAddress", fg="black", bg="skyblue", font=("arial", 10, "bold"), command=setAddressEvent)
button3.place(x=40, y=265)

entry3b = Entry(window)
entry3b.insert(END, 'Athlone')
entry3b.place(x=150, y=270)

button4 = Button(window, text="updateQual", fg="black", bg="skyblue", width=12, font=("arial", 10, "bold"), command=setQualEvent)
button4.place(x=40, y=295)

entry4b = Entry(window)
entry4b.insert(END, 'BSc')
entry4b.place(x=150, y=300)

button5 = Button(window, text="updateCourse", fg="black", bg="skyblue", width=12, font=("arial", 10, "bold"), command=setCourseEvent)
button5.place(x=40, y=325)

entry5b = Entry(window)
entry5b.insert(END, 'Software Design')
entry5b.place(x=150, y=330)

button6 = Button(window, text="stepLevel", fg="black", bg="skyblue", width=12, font=("arial", 10, "bold"), command=stepLevelEvent)
button6.place(x=40, y=360)

button7 = Button(window, text="Exit", fg="white", bg="black", width="8", font=("arial", 10, "bold"), command=exitEvent)
