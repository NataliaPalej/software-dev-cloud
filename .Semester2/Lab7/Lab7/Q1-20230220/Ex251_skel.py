...
label1 = Label(window, text="Module Details", fg="black", bg="plum1", font=("arial", 16, "bold"))  #
...
label3 = Label(window, text="Topic", fg="black", width=12, font=("arial", 10, "bold"))  #
...
label4 = Label(window, text="Lecturer", fg="black", width=8, font=("arial", 10, "bold"))  #
...
label5 = Label(window, text="Office", fg="black", width=12, font=("arial", 10, "bold"))  #
...
button3 = Button(window, text="updateTitle", fg="black", bg="pink1", font=("arial", 10, "bold"), command=setTitleEvent)
...
button4 = Button(window, text="updateOffice", fg="black", bg="pink1", font=("arial", 10, "bold"), command=setOfficeEvent)
