...
label1 = Label(window, text="PlayerCoach Details", fg="black", bg="palevioletred1", font=("arial", 16, "bold"))  #
...
label3 = Label(window, text="Title", fg="black", width=12, font=("arial", 10, "bold"))  #
...
label4 = Label(window, text="Licence", fg="black", width=8, font=("arial", 10, "bold"))  #
label4.place(x=60, y=140)

entry4 = Entry(window)
entry4.insert(END, '1')
entry4.place(x=130, y=140)

label5 = Label(window, text="Position", fg="black", width=12, font=("arial", 10, "bold"))  #
...
label6 = Label(window, text="GamesPlayed", fg="black", width=11, font=("arial", 10, "bold"))  #
...
# -------------------------------
button1 = Button(window, text="changeTitle", fg="black", bg="pink", width=12, font=("arial", 10, "bold"), command=changeTitleEvent)
...
button3 = Button(window, text="updateLicence", fg="black", bg="pink", width=12, font=("arial", 10, "bold"), command=resetLicenceEvent)
...
button4 = Button(window, text="GamesPlayed++", fg="black", bg="pink", width=12, font=("arial", 10, "bold"), command=resetGamesPlayedEvent)
button4.place(x=2, y=290)

button5 = Button(window, text="Exit", fg="white", bg="black", width=12, font=("arial", 10, "bold"), command=closeEvent)
