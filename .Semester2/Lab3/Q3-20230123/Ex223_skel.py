...
label1 = Label(window, text="PostGraduate Details", fg="black", bg="lightslateblue", font=("arial", 16, "bold"))  #
label1.place(x=40, y=30)  # place on screen

label2 = Label(window, text="Course", fg="black", width=8, font=("arial", 10, "bold"))  #
...
label3 = Label(window, text="YearOfStudy", fg="black", width=12, font=("arial", 10, "bold"))  #
...
label4 = Label(window, text="Topic", fg="black", width=8, font=("arial", 10, "bold"))  #
...
label5 = Label(window, text="TeachingHours", fg="black", width=12, font=("arial", 10, "bold"))  #
...
label6 = Label(window, text="Office", fg="black", width=8, font=("arial", 10, "bold"))  #
...
# -------------------------------
button1 = Button(window, text="incrYear", fg="black", bg="palevioletred1", font=("arial", 10, "bold"), command=incrYearEvent)
button1.place(x=40, y=230)

button2 = Button(window, text="Exit", fg="black", bg="palevioletred1", font=("arial", 10, "bold"), command=exitEvent)
button2.place(x=120, y=230)

button3 = Button(window, text="setHours", fg="black", bg="palevioletred1", font=("arial", 10, "bold"), command=setHoursEvent)
...
button4 = Button(window, text="setTopic", fg="black", bg="palevioletred1", font=("arial", 10, "bold"), command=setTopicEvent)
